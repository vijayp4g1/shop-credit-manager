  ...
  return (
    <>
      <button
        ...
        className="w-8 h-8 rounded-full bg-surface-container hover:bg-error-container/30 flex items-center justify-center transition-all duration-200 shrink-0 border border-outline-variant/30 shadow-sm"
      ...
      {isPortalMounted && typeof document !== 'undefined' && createPortal(
        <div className={`fixed inset-0 z-[100] flex items-center justify-center p-6 ${showConfirm ? "pointer-events-auto" : "pointer-events-none"}`}>
          ...
          >
            ...
            <h3 className="font-headline-sm text-headline-sm text-on-surface text-center mb-2">Delete Transaction?</h3>
            <p className="text-sm text-on-surface-variant text-center mb-6">
              This will remove the transaction and the customer&apos;s balance will update automatically.
            </p>
