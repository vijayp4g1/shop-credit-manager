    ...
    <div className="min-h-screen bg-surface pb-24 px-margin-mobile pt-20 max-w-5xl mx-auto space-y-6">
      ...
      <div className="fixed top-0 left-0 w-full z-50 bg-surface/80 backdrop-blur-lg border-b border-outline-variant/30 h-16 flex items-center justify-between px-margin-mobile">
        <div className="flex items-center gap-3">
          ...
          <div className="space-y-1.5">
            <div className="w-20 h-2 bg-surface-container-high/50 rounded animate-pulse"></div>
            <div className="w-24 h-3.5 bg-surface-container-highest rounded animate-pulse"></div>
          </div>
        </div>
      ...
      <div className="w-full bg-surface-container-lowest border border-outline-variant/30 rounded-[32px] p-6 shadow-sm animate-pulse space-y-6">
        <div className="flex items-center gap-5">
          <div className="w-16 h-16 rounded-full bg-surface-container-high/50"></div>
          <div className="space-y-2.5 flex-1">
            <div className="w-40 h-6 bg-surface-container-highest rounded"></div>
            <div className="w-28 h-3 bg-surface-container-high/50 rounded"></div>
          </div>
        </div>
        <div className="flex justify-between items-end pt-4">
          <div className="space-y-2">
            <div className="w-24 h-3 bg-surface-container-high/50 rounded"></div>
            <div className="w-36 h-10 bg-surface-container-highest/60 rounded"></div>
          </div>
          <div className="w-16 h-6 rounded-full bg-surface-container-high/50"></div>
        </div>
        <div className="grid grid-cols-2 gap-3 pt-4 border-t border-outline-variant/20">
          <div className="h-12 rounded-2xl bg-surface-container-high/50"></div>
          <div className="h-12 rounded-2xl bg-surface-container-high/50"></div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        {[1, 2].map((i) => (
          <div key={i} className="h-32 bg-surface-container-lowest border border-outline-variant/30 rounded-[28px] p-5 flex flex-col justify-between animate-pulse">
            ...
            <div className="w-24 h-8 bg-surface-container-highest/60 rounded"></div>
          </div>
        ))}
      </div>
          ...
          <div key={i} className="h-28 bg-surface-container-lowest border border-outline-variant/30 rounded-[24px] p-4 flex flex-col justify-between animate-pulse">
            <div className="flex justify-between items-start">
              <div className="space-y-2">
                ...
                <div className="w-20 h-2 bg-surface-container-high/50 rounded"></div>
              </div>
